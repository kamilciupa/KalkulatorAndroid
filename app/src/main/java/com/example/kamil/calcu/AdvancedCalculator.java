...
public class AdvancedCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_advanced_calculator);
...
*/
    ...
    public void setDot(View view){
        if(dotInside == false && calc.getText().length() > 0) {
    ...
    public void useCtg(View view) {
        if(calc.getText().length() != 0 && isANumber()) {
            val1 = Double.parseDouble(calc.getText().toString());
            val1 = 1.0 / Math.tan(val1);
            calc.setText(String.valueOf(val1));
            val1 = Double.NaN;
        } else {
            Toast.makeText(this, "No input", Toast.LENGTH_LONG).show();
